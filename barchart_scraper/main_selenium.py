...
driver.find_element(By.XPATH,
                    '//*[@id="bc-main-content-wrapper"]/div/div[2]/div[2]/div/div/div/div[1]/form/div[1]/input').send_keys(
    login)
driver.find_element(By.XPATH, '//*[@id="login-page-form-password"]').send_keys(password)
driver.find_element(By.XPATH,
                    '//*[@id="bc-main-content-wrapper"]/div/div[2]/div[2]/div/div/div/div[1]/form/div[6]/button').click()
